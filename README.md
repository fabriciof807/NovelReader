...
Veja [`docs/ARCHITECTURE-REVIEW.md`](docs/ARCHITECTURE-REVIEW.md) para o histórico de melhorias arquiteturais e [`handoff-YYYYMMDD.md`](handoff-20260620.md) para o estado atual do projeto.
